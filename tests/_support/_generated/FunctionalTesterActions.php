<?php //[STAMP] 7a862cdbcc9d8f51b5f1ddb2ef52844c
...
trait FunctionalTesterActions
{
     ...
     * @see \Codeception\Module\WPRequests::createNonce()
     */
    public function createNonce($action, $user = null)
    {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('createNonce', func_get_args()));
    }
     ...
     *
     * @return bool
     * @see \Codeception\Module\WPRequests::verifyNonce()
     */
    public function verifyNonce($nonce, $action, $user = null)
    {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('verifyNonce', func_get_args()));
    }
